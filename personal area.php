    ...
    <div class="container">
      <header class="main-header">
        ...
        <div class="main-header__side">
          <a class="main-header__side-item button button--transparent" href="logout.php">Выйти</a>
        </div>
      </header>

      <div class="content">
      <a class="button button--transparent  content__side-button" href="#" onclick="buttonOnClick()">Голосовать за проблему</a>
      
        <!-- <section class="welcome">
          <h2 class="welcome__heading">«Дела в порядке»</h2>

          <div class="welcome__text">
            <p>«Дела в порядке» — это веб приложение для указания социальных проблем и последующего их решения.</p>

            <p>После создания аккаунта, пользователь может начать указывать события на карте, а также следить за другими недостатками городов России. </p>
          </div>
