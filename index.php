<?php
    ...
    if ($_POST['change_button'] && isset($_POST['change_town'])) {
      ...
      if (in_array($_POST['change_town'], $town_array)) {
        $_COOKIE['city'] = $_POST['change_town'];
      }
      else {
        exit('Ошибка: Город не найден!');
      }
    }

    if ($_POST['sort_country']) {
      $bd_rate = $bd_rate;
    }
...
<head>
  <meta charset="UTF-8">
  <title>Проект "Дела в порядке"</title>
...
<div class="page-wrapper">
  <div class="container container--with-sidebar">
    <header class="main-header">
      <a href="index.php">
        <img src="img/allRight.png" width="153" height="100" alt="Логитип Дела в порядке" class="main-header__logo">
      </a>

      <div class="main-header__side">
      <form action="index.php" method="post">
        <input type="text" class="main-header__town-search" placeholder="Введите город" name="change_town" 
        value="<?php echo $_COOKIE['city']?>">
        <input type="submit" class="main-header__side-item button button--plus" value="Сменить город" name="change_button">
      </form>
    ...
    <div class="content__main-town-name"> 
      <h2 class="content__main-heading content__main-heading--left" align="center" >Город <?php echo $_COOKIE['city']; ?></h2>
    </div>

    <di class="content">
      <section class="content__side">
        <a class="button button--transparent  content__side-button" href="#" onclick="buttonOnClick()">+ Добавить проблему</a>
    
        <h2 class="content__side-heading content__side-heading--plus">Топ проблем</h2>
        <div class="content__side-sort">
          <form action="index.php" method="post" name="sort">
            <input type="submit" class="button button--transparent content__side-button-sort"name="sort_country" 
            value="По стране">
            <input type="submit" class="button button--transparent content__side-button-sort"name="sort_town" 
            value="По Городу">
        </form>
        ...
        <nav class="main-navigation">
          <ul class="main-navigation__list">
                <?php
              for($i = 0; $i < 5; $i++) {
                if (!isset($bd_rate[$i][0]['name'])) {
                  continue;
                }
        ?>
                <li class="main-navigation__list-item">
                <a class="main-navigation__list-item-link" href="#" onclick="coordsOnClick('<?php echo $bd_rate[$i][0]['coords'];?>');"><?php echo $bd_rate[$i][0]['name']; ?></a>
                <span class="main-navigation__list-item-count"> <?php echo $bd_rate[$i][0]['rating'];?> </span>
              </li>
              <?php
              }
            ?>
...
<footer class="main-footer">
  <div class="container">
    <div class="main-footer__copyright">
      <p>© 2021, «Дела в порядке»</p>

      <p>Разработка Александрова Кирилла <br> ФИиИТ 402</p>
    </div>
